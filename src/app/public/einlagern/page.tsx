...
function ScannerModal(props: {
  ...
  useEffect(() => {
    ...
    async function start() {
      ...
      const id = "brapool-scanner-einlagern";
        ...
        <div className="mt-4 grid grid-cols-12 gap-4">
          <div className="col-span-12 lg:col-span-8">
            <div className="overflow-hidden rounded-2xl border border-slate-200 dark:border-white/10 bg-black">
              <div id="brapool-scanner-einlagern" className="w-full" />
            </div>
    ...
    <div className="grid grid-cols-12 gap-4 md:gap-6">
      <div className="order-1 col-span-12 w-full">
        <section className="space-y-5">
          ...
          <div className="mt-2 text-sm text-zinc-400">Barcodes einfügen/scannen und einlagern. Status wird auf EINGELAGERT gesetzt.</div>
          <div className="mt-4">
            <button
