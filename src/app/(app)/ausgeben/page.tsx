      ...
      <div className="col-span-12 lg:col-span-9">
        <div className="max-w-3xl">
          ...
          <div className="mt-6 rounded-2xl border border-white/10 bg-white/5 p-5">
            ...
            <textarea
              className="w-full min-h-[240px] rounded-2xl border border-white/10 bg-white/5 p-4 font-mono text-sm"
              value={input}
              ...
              {summary.length ? (
                summary.map((s) => (
                  <div key={s.label} className="flex items-center justify-between rounded-xl border border-white/10 bg-white/5 px-4 py-3">
                    ...
                    <div className="ml-4 flex-1 text-sm opacity-90">{s.label}</div>
                  </div>
                ))
              ) : (
