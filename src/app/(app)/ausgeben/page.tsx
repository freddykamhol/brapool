    ...
    <div className="grid grid-cols-12 gap-4 md:gap-6">
      <div className="col-span-12 lg:col-span-9">
        <div className="w-full">
          ...
          <div className="mt-6 rounded-2xl border border-slate-200 bg-white dark:border-white/10 dark:bg-white/5 p-5">
            <div className="text-sm font-medium mb-2">Barcodes</div>
            <textarea
              className="w-full min-h-[240px] rounded-2xl border border-slate-200 bg-white dark:border-white/10 dark:bg-white/5 p-4 font-mono text-sm"
              value={input}
            ...
            <div className="mt-3 flex items-center justify-between">
              ...
              <button
                className="rounded-xl border border-slate-300 bg-slate-50 dark:border-white/10 dark:bg-white/10 px-5 py-2 hover:bg-slate-100 dark:hover:bg-white/15 disabled:opacity-50"
                onClick={ausgeben}
                disabled={!canSubmit}
              >
          ...
          {/* Summary list */}
          <div className="mt-6 rounded-2xl border border-slate-200 bg-white dark:border-white/10 dark:bg-white/5 overflow-hidden">
            ...
            <div className="p-5 space-y-2">
              {summary.length ? (
                summary.map((s) => (
                  <div key={s.label} className="flex items-center justify-between rounded-xl border border-slate-200 bg-white dark:border-white/10 dark:bg-white/5 px-4 py-3">
                    <div className="text-sm font-medium">{s.n}x</div>
                    <div className="ml-4 flex-1 text-sm text-zinc-200">{s.label}</div>
                  </div>
                ))
              ) : (
      ...
      <aside className="col-span-12 lg:col-span-3">
        <div className="rounded-2xl border border-slate-200 bg-white dark:border-white/10 dark:bg-white/5 p-5">
          ...
          <div className="mt-2 text-sm text-zinc-400">Scanner & Tools.</div>

          <div className="mt-5 space-y-3">
            <button
              className="w-full rounded-xl border border-slate-300 bg-slate-50 dark:border-white/10 dark:bg-white/10 px-4 py-3 text-left hover:bg-slate-100 dark:hover:bg-white/15"
